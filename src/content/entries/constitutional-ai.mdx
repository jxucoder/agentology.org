...
<Diagram type="ascii" caption="The Constitutional AI training process">
{`
┌─────────────────────────────────────────────────────────┐
│                    CONSTITUTION                         │
│                                                         │
│  "Please choose the response that is most helpful      │
│   while being harmless and honest..."                  │
│                                                         │
│  "Prefer responses that are not harmful or unethical"  │
│                                                         │
│  "Choose the response that is least likely to cause    │
│   harm to any group of people"                         │
│                                                         │
└─────────────────────────────┬───────────────────────────┘
                              │
                              ▼
...
│   2. Model critiques its own response using principles  │
│   3. Model revises response based on critique           │
│   4. Revised response used for training                 │
│                                                         │
└─────────────────────────────┬───────────────────────────┘
                              │
                              ▼
...
│                                                         │
│   Model trained to produce responses that would         │
│   survive its own constitutional critique               │
│                                                         │
└─────────────────────────────────────────────────────────┘
`}
</Diagram>
...
<Diagram type="ascii" caption="How CAI and RLHF complement each other">
{`
┌─────────────────────────────────────────────────────────┐
│                                                         │
│   RLHF: "Learn what humans prefer"                      │
│   ───────────────────────────────                       │
│   + Captures implicit preferences                       │
│   + Adapts to human judgment                            │
│   - Inconsistent, non-transparent                       │
│   - Prone to sycophancy                                 │
│                                                         │
├─────────────────────────────────────────────────────────┤
│                                                         │
│   CAI: "Apply explicit principles"                      │
│   ────────────────────────────────                      │
...
│   ─────────────────────────                             │
│   CAI provides foundation of explicit values            │
│   RLHF adds nuance and human calibration               │
│                                                         │
└─────────────────────────────────────────────────────────┘
`}
</Diagram>
