...
<Diagram type="ascii" caption="The ReAct cycle">
{`
┌──────────────────────────────────────────────────────┐
│                     ReAct LOOP                       │
├──────────────────────────────────────────────────────┤
│                                                      │
│   Thought → "I need to find the population of       │
│              Tokyo to answer this question"          │
│       │                                              │
│       ▼                                              │
│   Action → search("Tokyo population 2024")           │
│       │                                              │
│       ▼                                              │
│   Observation → "Tokyo has a population of           │
│                  approximately 13.96 million"        │
│       │                                              │
│       ▼                                              │
│   Thought → "Now I have the answer, I can           │
