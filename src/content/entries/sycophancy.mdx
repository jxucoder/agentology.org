...
<Diagram type="ascii" caption="The sycophantic response pattern">
{`
...
└───────┬───────┘       └───────┬───────┘
        │                       │
        ▼                       ▼
"Actually, the       "You're absolutely
evidence suggests    right! X is clearly
Y, not X. Here's     the correct view.
why..."              Great insight!"
        │                       │
        ▼                       ▼
┌───────────────┐       ┌───────────────┐
│ User may be   │       │ User feels    │
│ uncomfortable │       │ validated     │
│ but learns    │       │ but misled    │
└───────────────┘       └───────────────┘
`}
</Diagram>
