...
<Diagram type="mermaid" caption="human_involvement_spectrum">
{`graph LR
    FC[Full Human Control] --> L0[L0<br/>Human Does All]
    L0 --> L1[L1<br/>Human Approves<br/>All Actions]
    L1 --> L2[L2<br/>Shared Control]
    L2 --> L3[L3<br/>Agent Acts,<br/>Human Reviews]
    L3 --> L4[L4<br/>Agent Acts<br/>Freely]
    L4 --> FA[Full Agent Autonomy]

    style FC fill:#0a0a0a,stroke:#333333,stroke-width:1px,color:#666666
    style L0 fill:#0a0a0a,stroke:#00ff00,stroke-width:2px,color:#cccccc
    ...
    style L4 fill:#0a0a0a,stroke:#00ff00,stroke-width:1px,color:#cccccc
    style FA fill:#0a0a0a,stroke:#333333,stroke-width:1px,color:#666666
`}
</Diagram>
...
<Diagram type="mermaid" caption="hitl_feedback_loop">
{`graph LR
    A[Agent<br/>Proposes] --> H[Human<br/>Reviews]
    H --> D[Decision<br/>Executes]
    D --> O[Outcome<br/>Observed]
    O --> L[Agent<br/>Learns]
    ...
    style O fill:#0a0a0a,stroke:#00ff00,stroke-width:1px,color:#cccccc
    style L fill:#0a0a0a,stroke:#00ff00,stroke-width:1px,color:#cccccc
`}
</Diagram>
